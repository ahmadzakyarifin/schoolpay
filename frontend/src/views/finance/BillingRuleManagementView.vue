    ...
    <div class="bg-white rounded border border-slate-200 shadow-sm flex flex-col min-h-[710px] overflow-hidden">
      <div class="px-6 py-6 border-b border-slate-100 bg-slate-50/30 flex items-center justify-between">
        <div class="flex items-center gap-4">
          ...
          <h3 class="font-black text-slate-700 text-sm uppercase tracking-[0.2em]">{{ showHistory ? 'Riwayat Data Terhapus' : 'Otomatisasi Aturan Tagihan' }}</h3>
        </div>
        ...
        <div class="flex items-center gap-3">
          ...
          <button v-if="!showHistory" @click="openAddModal" class="bg-indigo-600 hover:bg-indigo-700 text-white font-black py-2 px-5 rounded-xl text-xs flex items-center gap-2 shadow-lg shadow-indigo-100 cursor-pointer">
